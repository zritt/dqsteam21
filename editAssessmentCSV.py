...
class assessmentCSV:
    ...
    def storeData(self, csv_file):
        ...
        self.oldData[self.index+5] = [self.data['test'], self.data['question1Correct'], self.data['question2Correct'], self.data['question3Correct'], self.data['question4Correct'], self.data['question5Correct'], self.data['question6Correct'], self.data['question7Correct'], self.data['question8Correct'], self.data['question9Correct'], self.data['question10Correct']]
