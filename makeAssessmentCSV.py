...
class assessmentCSV:
    ...
    def storeData(self, csv_file):
        ...
        row5 = [self.data['date'], self.data['question1Ans4'], self.data['question2Ans4'], self.data['question3Ans4'], self.data['question4Ans4'], self.data['question5Ans4'], self.data['question6Ans4'], self.data['question7Ans4'], self.data['question8Ans4'], self.data['question9Ans4'], self.data['question10Ans4']]
        row6 = [self.data['time'], self.data['question1Correct'], self.data['question2Correct'], self.data['question3Correct'], self.data['question4Correct'], self.data['question5Correct'], self.data['question6Correct'], self.data['question7Correct'], self.data['question8Correct'], self.data['question9Correct'], self.data['question10Correct']]
